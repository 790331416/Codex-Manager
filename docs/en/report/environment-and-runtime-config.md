...
- `CODEXMANAGER_SERVICE_ADDR`：service 地址，默认 `localhost:45760`
- `CODEXMANAGER_WEB_ADDR`：web 地址，默认 `localhost:45761`
...
```dotenv
CODEXMANAGER_SERVICE_ADDR=localhost:45760
...
```dotenv
CODEXMANAGER_SERVICE_ADDR=0.0.0.0:45760
